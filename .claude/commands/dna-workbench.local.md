...
4. Expand all relative file links to absolute GitHub URLs using a linked ↗ symbol after the title: `Title [↗](https://github.com/NXD-Solutions/.github/blob/main/.claude/rules/<file>.md#<anchor>)`. Titles stay as plain text. Entries without a link stay as plain text with no symbol.
