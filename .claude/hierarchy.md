...
- **[Transparent by Nature](rules/core/dna.md#transparent-by-nature)** — Strand
  ...
  - **[Write for the widest audience first](rules/core/principles.md#write-for-the-widest-audience-first)** — Principle
    ...
    - [Reader's vocabulary](rules/core/communicative-artefact.md#facets) — Facet
  - **[Every communicative artefact serves the reader's context — not the system's structure](rules/core/communicative-artefact.md#communicative-artefact)** — Principle
...
- **[Resilient by Design](rules/core/dna.md#resilient-by-design)** — Strand
  ...
  - **[Reference the authority to prevent drift](rules/core/principles.md#reference-the-authority-to-prevent-drift)** — Principle
    - [Inlining authority-owned facts](rules/core/communicative-artefact.md#inlining-authority-owned-facts) — Rule
---
