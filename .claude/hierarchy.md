...
- **[Transparent by Nature](rules/thinking-core/dna.md#transparent-by-nature)** — Strand
  ...
  - **[Write for the widest audience first](rules/thinking-core/principles.md#write-for-the-widest-audience-first)** — Principle
    ...
    - [Reader's vocabulary](rules/thinking-core/communicative-artefact.md#facets) — Facet
  - **[Every communicative artefact serves the reader's context — not the system's structure](rules/thinking-core/communicative-artefact.md#communicative-artefact)** — Principle
    - [Define Audience before writing](rules/thinking-core/communicative-artefact.md#define-audience-before-writing) — Rule
    - [Define Topic before writing](rules/thinking-core/communicative-artefact.md#define-topic-before-writing) — Rule
    - [Define Trigger before writing](rules/thinking-core/communicative-artefact.md#define-trigger-before-writing) — Rule
    - [Reader-need filter](rules/thinking-core/communicative-artefact.md#reader-need-filter) — Rule
    - [Problem introduction](rules/thinking-core/communicative-artefact.md#facets) — Facet
    - [Visible consequences](rules/thinking-core/communicative-artefact.md#facets) — Facet
    ...
    - **[Every element earns its place](rules/thinking-core/communication.md#every-element-earns-its-place-by-serving-the-readers-current-position-in-the-document)** — Sub-principle
...
- **[Lean by Design](rules/thinking-core/dna.md#lean-by-design)** — Strand
  ...
  - **[Start lean, don't close the door](rules/thinking-core/principles.md#start-lean-dont-close-the-door)** — Principle
  - **[Name constraint boundaries](rules/thinking-core/principles.md#name-constraint-boundaries)** — Principle
---
- **[Resilient by Design](rules/thinking-core/dna.md#resilient-by-design)** — Strand
  ...
  - **[Reference the authority to prevent drift](rules/thinking-core/principles.md#reference-the-authority-to-prevent-drift)** — Principle
    - [Inlining authority-owned facts](rules/thinking-core/communicative-artefact.md#inlining-authority-owned-facts) — Rule
    - [Platform Contracts](rules/dev/platform-contracts.md#platform-contracts) — Rule
---
- **[Evolving by Instinct](rules/thinking-core/dna.md#evolving-by-instinct)** — Strand
  - **[Challenge until conviction](rules/thinking-core/principles.md#challenge-until-conviction)** — Principle
    ...
    - [CR execution gate — deliberation package travels to implementation](rules/nxd-practices/ai-human-conventions.md#cr-execution-gate--deliberation-package-travels-to-implementation) — Rule
  - **[Every gap signal is an improvement trigger](rules/thinking-core/principles.md#every-gap-signal-is-an-improvement-trigger)** — Principle
    ...
    - [Every correction is an opportunity to improve the process](rules/nxd-practices/ai-human-conventions.md#every-correction-is-an-opportunity-to-improve-the-process) — Rule
...
- **[Pattern-seeking by Instinct](rules/thinking-core/dna.md#pattern-seeking-by-instinct)** — Strand
  ...
  - **[Invariants before options](rules/thinking-core/principles.md#invariants-before-options)** — Principle
  - **[Test simultaneously, not serially](rules/thinking-core/principles.md#test-simultaneously-not-serially)** — Principle
  - **[Invariants are not choices](rules/thinking-core/principles.md#invariants-are-not-choices)** — Principle
  - **[Failed candidates are teachers](rules/thinking-core/principles.md#failed-candidates-are-teachers)** — Principle
...
- **[Preserve the ability to change](rules/nxd-practices/policies.md#preserve-the-ability-to-change)** — Policy
  - [No vendor lock-in](rules/thinking-core/principles.md#no-vendor-lock-in) — enforcing principle
  - [Prefer reversible decisions](rules/thinking-core/principles.md#prefer-reversible-decisions) — enforcing principle
  - [Start lean, don't close the door](rules/thinking-core/principles.md#start-lean-dont-close-the-door) — enforcing principle
...
- [Principal](rules/nxd-practices/glossary.md#principal)
