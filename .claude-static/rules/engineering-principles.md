...
Cross-cutting mindset that applies to all code, rules, integrations, and decisions.
These principles inform the *how* and *why* behind specific standards.
...
*A rule enforced automatically is a rule no one needs to remember.*
...
## Security is baseline, not a feature
