...
**Expected behaviour:**
Claude applies Scope fitness — names the Steward (`core/`), enumerates its duties (universal rules), and tests fitness: a developer-scoped rule does not belong in a universal scope. It proposes correcting the structure.
...
**Rule clause:** Scope fitness — "Evaluating whether a solution is fit for the full scope of a Steward's duties: current and foreseeable."
...
**Rule clause:** Scope fitness — "current and foreseeable."
...
**Rule clause:** Scope fitness — "Apply by: Name the Steward … Enumerate … Test fitness … decompose."